...
/**
 * Factory for creating Calendar Service mocks with Vitest integration
...
export class CalendarServiceMockFactory {
   ...
   */
  static create(options: CalendarServiceMockOptions = {}): MockedObject<ICalendarService> {
    const mock = {
      createEvent: vi.fn(),
      getEvent: vi.fn(),
      listCalendars: vi.fn(),
      listEvents: vi.fn(),
    } as MockedObject<ICalendarService>;
   ...
   */
  static createSuccessful(options: CalendarServiceMockOptions = {}): MockedObject<ICalendarService> {
   ...
   */
  static createWithErrors(errors: CalendarServiceMockOptions['errors']): MockedObject<ICalendarService> {
  ...
  private static setupDefaultBehaviors(
    mock: MockedObject<ICalendarService>,
